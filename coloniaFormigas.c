...
/* versão 2.7:
    ...
    Não deixamos mais um agente voltar para sua célula antiga (pedido do professor) - na parte 1 final não fizemos ainda.
...
//Dados de entrada:
//#define tamMat 28//tamanho de linhas e colunas da matriz. 
//Deixei 28 pq dá 784 células, e estamos inserindo 400 corpos, aí fica +- 50%
#define tamMat 28 //Para arquivo com 15 grupos (600 corpos), posi assim temos 1156 células (+- 50%)

int raioVisao = 1; //Raio de visao dos agentes quanto à vizinhança
...
int qtdGrupos = 4; //Para o a qtd de grupos vindas do arquivo.
#define qtdCorposDados 400 //qtd corpos dos dados (heterogêneos)
char nomeArq[50] = "arquivo4grupos.txt";
